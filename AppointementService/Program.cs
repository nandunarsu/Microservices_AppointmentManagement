...
builder.Services.AddHttpClient("GetDoctorById", client =>
{
    client.BaseAddress = new Uri("https://localhost:7151/api/Doctor/"); // Replace with your external service base URL
